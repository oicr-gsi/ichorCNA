...
workflow ichorCNA_ultimagen {
  ...
  parameter_meta {
    ...
    windowSize: "The size of non-overlapping windows (bin size in bp)."
    minimumMappingQuality: "Mapping quality value below which reads are ignored."
    chromosomesToAnalyze: "Chromosomes in the cram reference file."
  ...
  String refFasta = resources [ reference ].refFasta
